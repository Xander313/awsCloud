...
DATABASES = {
    'default': {
        ...
        'NAME': 'mainDB',      # Reemplaza con el nombre de tu base
        'USER': 'root',                   # O el usuario que uses en tu contenedor
        'PASSWORD': 'admin',  # La contraseña configurada
        'HOST': '172.22.0.2',              # O '127.0.0.1'
        'PORT': '3306',
    }
}
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'aiza4840@gmail.com' # Tu correo electrónico
EMAIL_HOST_PASSWORD = 'zjyy ntek uqob qvvz' # Tu contraseña de aplicación de Gmail
